  ...
  <div class="result-page">
    ...
    <div class="flex-container">
      <h1>
        ...
        <span
          class="highlight"
          :style="{ color: $store.getters.category.category_color }"
          >{{ score.score }}</span
        >
        /{{ score.total }}
      </h1>
      <router-link to="/categories" class="link">
        <button
          ...
          :style="{ backgroundColor: $store.getters.category.category_color }"
        >
          Play another Quiz
        </button>
      </router-link>
      <h2 class="share-header">
        Challenge your friends now! Share your scores on
      </h2>
      <br />
      <br />
      <div>
